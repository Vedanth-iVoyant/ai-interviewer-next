...
export default function Sidebar() {
  ...
  const sampleEmail = username ? `${username.toLowerCase()}@talentgate.ai` : '';
  ...
  return (
    ...
    >
      ...
      <div style={{ padding: "0.75rem", borderTop: "1px solid var(--border)" }}>
        {/* Avatar + name + email */}
        <div style={{ display: "flex", alignItems: "center", gap: "0.65rem", padding: "0.5rem 0.4rem", marginBottom: "0.25rem" }}>
          <div style={{
        ...
        <button
          ...
          style={{
            ...
            padding: "0.55rem 0.8rem", borderRadius: 8, border: "none",
